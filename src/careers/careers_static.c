...
static struct cr_career static_career_list[] = {
    ...
    CAREER(CRID_BODYGUARD, "Bodyguard" ),
        ...
        TRAPPINGS(IID_HAND_WEAPON, IID_THROWING_KNIFE, IID_THROWING_KNIFE, IID_LEATHER_JACK),
        EXITS(CRID_MERCENARY),
        .weight = { [MSR_RACE_DWARF]=3, [MSR_RACE_ELF]=1, [MSR_RACE_HALFLING]=1, [MSR_RACE_HUMAN]=2, },
    CAREER_END,
