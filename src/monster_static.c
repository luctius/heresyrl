...
#define HUMAN(tid,ic,sdn,ldn,desc,gnr,mwound,ws,bs,st,tg,ag,pr,in,wl,fl,rtrait,comtrait,cartrait,creatrait,innwpn,skills...) \
    ...
    .innate_weapon=innwpn, .characteristic[MSR_CHAR_WEAPON_SKILL]={ .base_value=ws,}, .characteristic[MSR_CHAR_BALISTIC_SKILL]={ .base_value=bs,}, \
    ...
    .characteristic[MSR_CHAR_FELLOWSHIP]={ .base_value=fl,}, ##skills}

#define BASIC_FERAL_DESC "description of a basic feral human"

struct msr_monster static_monster_list[] = {
    HUMAN(MSR_ID_BASIC_FERAL,'h',"human","a basic human",BASIC_FERAL_DESC,MSR_GENDER_MALE,14,30,30,30,30,30,30,30,30,30,0,0,0,0,0),
};
