...
#define HUMAN(tid,ic,sdn,ldn,desc,gnr,mwound,ws,bs,st,tg,ag,pr,in,wl,fl,rtrait,comtrait,cartrait,creatrait,innwpn,sk_basic, sk_adv, sk_exp) \
...
struct msr_monster static_monster_list[] = {
    HUMAN(MSR_ID_BASIC_FERAL,'h',"human","a basic human",BASIC_FERAL_DESC,MSR_GENDER_MALE,14,30,30,30,30,30,30,30,30,30,0,0,0,0,0,0,0,0),
};
