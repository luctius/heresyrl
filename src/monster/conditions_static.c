...
static struct cdn_condition static_condition_list[] = {
    ...
    CONDITION(CID_WITHDRAWL_HEALTH_STIMM, "health stimm withdrawl", "", "You start to crave for more health stimms.", "%s starts to shake.", "You overcome your cravings.", "%s regains his posture.", 
            ...
            TICK_EFFECT(CDN_EF_DECREASE_WS,   0, CDN_STRENGTH_FIVE, 0,          4), 
            TICK_EFFECT(CDN_EF_DECREASE_BS,   0, CDN_STRENGTH_FIVE, 0,          4), 
            TICK_EFFECT(CDN_EF_DECREASE_STR,  0, CDN_STRENGTH_FIVE, 0,          4), 
            TICK_EFFECT(CDN_EF_DECREASE_AG,   0, CDN_STRENGTH_FIVE, 0,          4), 
            TICK_EFFECT(CDN_EF_DECREASE_TGH,  0, CDN_STRENGTH_FIVE, 0,          4), 
            TICK_EFFECT(CDN_EF_DECREASE_PER,  0, CDN_STRENGTH_FIVE, 0,          4), 
            TICK_EFFECT(CDN_EF_DECREASE_WILL, 0, CDN_STRENGTH_FIVE, 0,          4), 
            TICK_EFFECT(CDN_EF_DECREASE_INT,  0, CDN_STRENGTH_FIVE, 0,          4), 
            TICK_EFFECT(CDN_EF_DECREASE_FEL,  0, CDN_STRENGTH_FIVE, 0,          4), ),
            /*Settings      Flags                                                               Difficulty    Next     Minimum  -  Maximum Turns*/
            SETTINGS(bf(CDN_CF_REQ_CHEM_USE_CHECK) | bf(CDN_CF_DETOXABLE), -20,   CID_NONE,   20,          50),
    CONDITION_END,
    ...
    CONDITION(CID_HEALTH_STIMM, "health stimm", "", "Your wounds begin to heal.", "%s's wounds begin to heal.", "You feel the healing wearing off.", NULL, 
            ...
            TICK_EFFECT(CDN_EF_HEALTH_TICK, 0,   CDN_STRENGTH_ONE, 0,           1), ),
            /*Settings      Flags                 Difficulty    Next             Minimum  -  Maximum Turns*/
            SETTINGS( bf(CDN_CF_REMOVE_CONTINUE), 0, CID_WITHDRAWL_HEALTH_STIMM, 10,        10),
    CONDITION_END,

    CONDITION(CID_FATEHEALTH, "fatepoint_health", "", NULL, NULL, NULL, NULL, 
            /* Type         Effect        Flags     Strength     Difficulty   Interval */
            TICK_EFFECT(CDN_EF_HEALTH_TICK, 0, CDN_STRENGTH_TEN,    0,            1), ),
            /*Settings      Flags     Difficulty    Next             Minimum  -  Maximum Turns*/
    ...
    CONDITION(CID_DEATH_STIMM, "death stimm", "", NULL, NULL, NULL, NULL,
            /* Type         Effect        Flags     Strength     Difficulty   Interval   */
            TICK_EFFECT(CDN_EF_INSTANT_DEATH,       0,  CDN_STRENGTH_NONE, 0,            0), ),
            /*Settings      Flags     Difficulty    Next          Minimum  -  Maximum Turns*/
            SETTINGS(       0,        0,          CID_NONE,      0,          0),
    CONDITION_END,
    ...
    CONDITION(CID_WEAPON_FLAME, "flames", "flames are engulving you", "You catch fire.", "%s has catched fire.", "You manage to put out the flames.", "%s stomps out the flames.", 
            /* Type         Effect           Flags                        Strength          Difficulty   Interval   */
            EFFECT(     CDN_EF_ON_FIRE,          0,                       CDN_STRENGTH_NONE,     0),
            TICK_EFFECT(CDN_EF_DAMAGE_TICK, bf(CDN_ESF_DMG_TYPE_ENERGY),  CDN_STRENGTH_1D10,     0,           1), ),
            /*Settings      Flags     Difficulty    Next          Minimum  -  Maximum Turns*/
            SETTINGS(bf(CDN_CF_REQ_AG_CHECK), 0, CID_NONE, 1, 10),
    CONDITION_END,
    ...
    CONDITION(CID_ENERGY_CRITICAL_HEAD_1, "energy critical head 1", "", "", "", "", "", 
            EFFECT(CDN_EF_DECREASE_WS,   0, CDN_STRENGTH_TEN, 0), 
            EFFECT(CDN_EF_DECREASE_BS,   0, CDN_STRENGTH_TEN, 0), 
            EFFECT(CDN_EF_DECREASE_STR,  0, CDN_STRENGTH_TEN, 0), 
            EFFECT(CDN_EF_DECREASE_AG,   0, CDN_STRENGTH_TEN, 0), 
            EFFECT(CDN_EF_DECREASE_PER,  0, CDN_STRENGTH_TEN, 0), 
            EFFECT(CDN_EF_DECREASE_WILL, 0, CDN_STRENGTH_TEN, 0), 
            EFFECT(CDN_EF_DECREASE_INT,  0, CDN_STRENGTH_TEN, 0), 
            EFFECT(CDN_EF_DECREASE_FEL,  0, CDN_STRENGTH_TEN, 0), ),
            SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 1, 1),
    CONDITION_END,

    /* blinded for 1 round */
    CONDITION(CID_ENERGY_CRITICAL_HEAD_2, "energy critical head 2", "", "", "", "", "", 
            EFFECT(CDN_EF_BLINDNESS,  0, CDN_STRENGTH_NONE, 0), ),
            SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 1, 1),
    CONDITION_END,

    /* stunned for 1 round, 1 lvl of fatique */
    CONDITION(CID_ENERGY_CRITICAL_HEAD_3, "energy critical head 3", "", "", "", "", "", 
            EFFECT(CDN_EF_STUNNED,        0, CDN_STRENGTH_NONE, 0),
            EFFECT(CDN_EF_DECREASE_FATIQUE, 0, CDN_STRENGTH_ONE,  0), ),
            SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 1, 1),
    CONDITION_END,
    ...
    CONDITION(CID_ENERGY_CRITICAL_HEAD_4, "energy critical head 4", "", "", "", "", "", 
            EFFECT(CDN_EF_BLINDNESS,      0, CDN_STRENGTH_NONE, 0),
            EFFECT(CDN_EF_DECREASE_FATIQUE, 0, CDN_STRENGTH_TWO,  0), ),
            SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 1, 5),
    CONDITION_END,

    CONDITION(CID_ENERGY_CRITICAL_HEAD_5, "energy critical head 5", "", NULL, "", NULL, "", 
            EFFECT(CDN_EF_INSTANT_DEATH,  0, CDN_STRENGTH_NONE, 0), ),
            SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 0, 0),
    CONDITION_END,
    ...
    CONDITION_END,
                ...
                CONDITION(CID_IMPACT_CRITICAL_HEAD_1, 
                            ...
                            NULL,
                            NULL, 
                        EFFECT(CDN_EF_DECREASE_FATIQUE,  bf(CDN_ESF_REQ_TGH_CHECK) , CDN_STRENGTH_ONE, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 1, 1),
                CONDITION_END,
                ...
                CONDITION(CID_IMPACT_CRITICAL_HEAD_2,
                            ...
                            NULL, 
                        EFFECT(CDN_EF_BLINDNESS,                         0, CDN_STRENGTH_NONE, 0),
                        EFFECT(CDN_EF_STUNNED,   bf(CDN_ESF_REQ_TGH_CHECK), CDN_STRENGTH_NONE, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 1, 1),
                CONDITION_END,
                ...
                CONDITION(CID_IMPACT_CRITICAL_HEAD_3,
                        ...
                        EFFECT(CDN_EF_STUNNED,        0,                     CDN_STRENGTH_NONE, 0),
                        EFFECT(CDN_EF_DECREASE_FATIQUE, 0,                     CDN_STRENGTH_ONE,  0),
                        EFFECT(CDN_EF_DECREASE_INT,     bf(CDN_ESF_PERMANENT), CDN_STRENGTH_ONE,  0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE),  0, CID_NONE, 1, 1),
                CONDITION_END,
                ...
                CONDITION(CID_IMPACT_CRITICAL_HEAD_5,
                        ...
                        EFFECT(CDN_EF_EXPLODE,       0, CDN_STRENGTH_NONE, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 0, 0),
                CONDITION_END,

                /* Chest */
                CONDITION(CID_IMPACT_CRITICAL_BODY_1,
                            ...
                            NULL,
                        EFFECT(CDN_EF_STUNNED,       0, CDN_STRENGTH_NONE, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 0.5, 0.5),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_BODY_2, 
                            ...
                            NULL, 
                        EFFECT(CDN_EF_STUNNED, 0, CDN_STRENGTH_NONE, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 1.5, 1.5),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_BODY_3,
                            ...
                            NULL,
                        EFFECT(CDN_EF_STUNNED,        0,                         CDN_STRENGTH_NONE,  0),
                        EFFECT(CDN_EF_DECREASE_FATIQUE, bf(CDN_ESF_REQ_TGH_CHECK), CDN_STRENGTH_1D5,   0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE),  0, CID_NONE, 2, 2),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_BODY_4,
                            ...
                            NULL,
                            NULL,
                        EFFECT(CDN_EF_BLOODLOSS,      0, CDN_STRENGTH_NONE,   0),
                        EFFECT(CDN_EF_DECREASE_FATIQUE, 0, CDN_STRENGTH_1D10,   0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE),  0, CID_NONE, 1, 10),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_BODY_5, 
                ...
                /* Right Arms */
                CONDITION(CID_IMPACT_CRITICAL_RARMS_1,
                            ...
                            NULL,
                            NULL,
                        EFFECT(CDN_EF_DISABLE_RARM,  0, CDN_STRENGTH_NONE, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 1, 1),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_RARMS_2,
                ...
                CONDITION(CID_IMPACT_CRITICAL_RARMS_3,
                            ...
                            NULL,
                        EFFECT(CDN_EF_DISABLE_RARM,  0, CDN_STRENGTH_NONE, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 50, 200),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_RARMS_4,
                            ...
                            NULL,
                        EFFECT(CDN_EF_DISABLE_RARM,  0, CDN_STRENGTH_NONE, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE), bf(CDN_CF_PERMANENT), CID_NONE, 0, 0),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_RARMS_5,
                ...
                /* Right Legs */
                CONDITION(CID_IMPACT_CRITICAL_RLEGS_1,
                ...
                CONDITION(CID_IMPACT_CRITICAL_RLEGS_2,
                            ...
                            NULL,
                            NULL,
                        EFFECT(CDN_EF_DISABLE_RLEG,   0, CDN_STRENGTH_NONE, 0),
                        EFFECT(CDN_EF_DECREASE_FATIQUE, 0, CDN_STRENGTH_1D5,  0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE),  0, CID_NONE, 1, 5),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_RLEGS_3,
                            ...
                            NULL,
                            NULL,
                        EFFECT(CDN_EF_DECREASE_AG,      0, CDN_STRENGTH_1D5, 0),
                        EFFECT(CDN_EF_DECREASE_FATIQUE, 0, CDN_STRENGTH_1D5, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE),  0, CID_NONE, 0, 0),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_RLEGS_4,
                            ...
                            NULL,
                            NULL,
                        EFFECT(CDN_EF_DISABLE_RLEG,   0, CDN_STRENGTH_1D5, 0),
                        EFFECT(CDN_EF_DECREASE_FATIQUE, 0, CDN_STRENGTH_TWO, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE) | bf(CDN_CF_PERMANENT), 0, CID_NONE, 0, 0),
                CONDITION_END,
                ...
                /* Left Arms */
                CONDITION(CID_IMPACT_CRITICAL_LARMS_1,
                            "impact critical arms 1",
                            "",
                            ...
                            NULL,
                            NULL,
                        EFFECT(CDN_EF_DISABLE_LARM,  0, CDN_STRENGTH_NONE, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE), 0, CID_NONE, 1, 1),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_LARMS_2,
                            "impact critical arms 2",
                            "",
                ...
                CONDITION(CID_IMPACT_CRITICAL_LARMS_3,
                            "impact critical arms 3",
                            "",
                ...
                CONDITION(CID_IMPACT_CRITICAL_LARMS_4,
                            "impact critical arms 4",
                            "",
                ...
                CONDITION(CID_IMPACT_CRITICAL_LARMS_5,
                            "impact critical arms 5",
                            "",
                            NULL,
                            NULL,
                ...
                /* Left Legs */
                CONDITION(CID_IMPACT_CRITICAL_LLEGS_1,
                            "impact critical legs 1",
                            "",
                ...
                CONDITION(CID_IMPACT_CRITICAL_LLEGS_2,
                            "impact critical legs 2",
                            "",
                            ...
                            NULL,
                            NULL,
                        EFFECT(CDN_EF_DISABLE_LLEG,   0, CDN_STRENGTH_NONE, 0),
                        EFFECT(CDN_EF_DECREASE_FATIQUE, 0, CDN_STRENGTH_1D5,  0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE),  0, CID_NONE, 1, 5),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_LLEGS_3,
                                "impact critical legs 3",
                                "",
                                "A powerful impact to the right leg causes micro fractures in your bones, inflicting considerable agony.",
                                "A powerful impact to the right leg causes micro fractures in your bones, inflicting considerable agony.",
                ...
                CONDITION(CID_IMPACT_CRITICAL_LLEGS_4,
                            "impact critical legs 4",
                            "",
                            "With a nasty crunch, the right leg is broken and you are knocked down mewling in pain.",
                            "With a nasty crunch, the right leg is broken and %s is knocked down mewling in pain.",
                            NULL,
                            NULL,
                        EFFECT(CDN_EF_DISABLE_LLEG,   0, CDN_STRENGTH_1D5, 0),
                        EFFECT(CDN_EF_DECREASE_FATIQUE, 0, CDN_STRENGTH_TWO, 0), ),
                        SETTINGS( bf(CDN_CF_UNIQUE) | bf(CDN_CF_PERMANENT), 0, CID_NONE, 0, 0),
                CONDITION_END,

                CONDITION(CID_IMPACT_CRITICAL_LLEGS_5,
                            "impact critical legs 5",
                            "",
                            NULL,
                            NULL,
