...
struct cdn_condition static_condition_list[] = {
    ...
    CONDITION(CID_WITHDRAWL_HEALTH_STIMM, "health stimm withdrawl", "", "are suffering from withdrawl", "starts to shake", "overcome your urge", "regains his posture", 
            ...
            SETTINGS( bf(CDN_SF_REQ_CHEM_USE_CHECK) | bf(CDN_SF_DETOXABLE), -20, CID_NONE, 20, 50),
    CONDITION_END,
    ...
    CONDITION(CID_ENERGY_CRITICAL_HEAD_10, "", "", NULL, "", NULL, "", 
            EFFECT(CDN_EF_DEATH,  0, CDN_DAMAGE_NONE, 0, CDN_PRIORITY_PERMANENT), ),
            SETTINGS( 0, 0, CID_NONE, 0, 0),
    CONDITION_END,
};
