...
static struct cdn_condition static_condition_list[] = {
    ...
    CONDITION_END,
                ...
                CONDITION(CID_IMPACT_CRITICAL_HEAD_4, 
                            ...
                            "Blood pours from %s eyes, ears and nose as the attack pulverizes %s brain.", 
                        EFFECT(CDN_EF_DEATH,         0, CDN_DAMAGE_NONE,  0), ),
                        SETTINGS( bf(CDN_SF_UNIQUE), 0, CID_NONE, 0, 0),
                CONDITION_END,
                ...
                CONDITION(CID_IMPACT_CRITICAL_RARMS_5,
                            ...
                            "In a rain of blood, gore and meat, the right arm is removed from %s's body. Screaming incoherently, %s twists about in agony for a few seconds before collapsing to the ground.",
                        EFFECT(CDN_EF_DEATH,         0, CDN_DAMAGE_NONE, 0), ),
                        SETTINGS( bf(CDN_SF_UNIQUE), 0, CID_NONE, 0, 0),
                CONDITION_END,
                ...
                CONDITION(CID_IMPACT_CRITICAL_LARMS_5,
                            ...
                            "In a rain of blood, gore and meat, the left arm is removed from %s's body. Screaming incoherently, %s twists about in agony for a few seconds before collapsing to the ground.",
                        EFFECT(CDN_EF_DEATH,         0, CDN_DAMAGE_NONE, 0), ),
                        SETTINGS( bf(CDN_SF_UNIQUE), 0, CID_NONE, 0, 0),
                CONDITION_END,
