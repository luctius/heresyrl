...
struct itm_item static_item_list[] = {
    LIGHT(ITEM_ID_FIXED_LIGHT,"torch","a torch",AVERAGE_TORCH_DESC,4,65000,ITEM_AVAILABILITY_POOR,ITEM_QUALITY_AVERAGE,1,1,0),
    LIGHT(ITEM_ID_AVERAGE_TORCH,"torch","a torch",AVERAGE_TORCH_DESC,4,100,ITEM_AVAILABILITY_PLENTIFUL,ITEM_QUALITY_AVERAGE,1,1,1),
