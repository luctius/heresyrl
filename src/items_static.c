...
#define CLOTHING(item_id,item_sd_name,item_ld_name,item_desc,cloth_typ,dr,avail,item_quality,item_weight,item_cost,delay) \
    [item_id] = { .uid=0, .template_id=item_id, .item_type=ITEM_TYPE_WEARABLE, .availability=avail, .quality=item_quality, \
...
#define CREATURE_MELEE(item_id,item_sd_name,item_ld_name,item_desc,wpn_cat,dmg_die,dmg_add,dmg_tp,pen,unarmed,avail,item_quality,item_weight,item_cost,delay,special) \
    ...
    .dmg_type=dmg_tp, .nr_dmg_die=dmg_die, .dmg_addition=dmg_add, .range=0, .penetration=pen, .special_quality=special, .jammed=false, .is_unarmed=unarmed, }, }
...
#define LIGHT(item_id,item_sd_name,item_ld_name,item_desc,lumin,dur,avail,item_quality,item_weight,item_cost,delay) \
    [item_id] = { .uid=0, .template_id=item_id, .item_type=ITEM_TYPE_TOOL, .availability=avail, .quality=item_quality, \
    .attributes=ITEM_ATTRIBUTE_NONE, .age=0, .weight=item_weight, .cost=item_cost, .sd_name=item_sd_name, \
    .ld_name=item_ld_name, .description=item_desc, .icon='(', .icon_attr=COLOR_PAIR(DPL_COLOUR_NORMAL), .use_delay=delay, \
...
#define AMMO(item_id,item_sd_name,item_ld_name,item_desc,ammo_typ,energ,avail,item_quality,item_weight,item_cost,delay) \
    [item_id] = { .uid=0, .template_id=item_id, .item_type=ITEM_TYPE_AMMO, .availability=avail, .quality=item_quality, \
    .attributes=ITEM_ATTRIBUTE_NONE, .age=0, .weight=item_weight, .cost=item_cost, .sd_name=item_sd_name, \
    .ld_name=item_ld_name, .description=item_desc, .icon='\'', .icon_attr=COLOR_PAIR(DPL_COLOUR_NORMAL), .use_delay=delay, \
...
struct itm_item static_item_list[] = {
    CREATURE_MELEE(ITEM_ID_HUMAN_UNARMED,"hands","hands","",WEAPON_CATEGORY_2H_MELEE,0,-3,WEAPON_DMG_TYPE_IMPACT,0,true,0,60000,0,0,1,0),
    ...
    RANGED(ITEM_ID_AVERAGE_STUB_AUTOMATIC,"stub automatic","a stub automatic",AVERAGE_STUB_AUTOMATIC_DESC,WEAPON_CATEGORY_PISTOL,1,3,
                WEAPON_DMG_TYPE_IMPACT,0,30,1,3,0,9,ITEM_AVAILABILITY_PLENTIFUL,ITEM_QUALITY_AVERAGE,15,50,1,1),
    RANGED(ITEM_ID_AVERAGE_STUB_REVOLVER,"stub revolver","a stub revolver",AVERAGE_STUB_REVOLVER_DESC,WEAPON_CATEGORY_PISTOL,1,3,
                WEAPON_DMG_TYPE_IMPACT,0,30,1,0,0,6,ITEM_AVAILABILITY_PLENTIFUL,ITEM_QUALITY_AVERAGE,15,50,1,1),
