...
#define MSR_TALENT_HEADER_MASK  (0x0FULL<<MSR_TALENT_HEADER_SHIFT)
#define MSR_TALENT_ID_MASK      (~MSR_TALENT_HEADER_MASK)
#define MSR_TALENT_HEADER(a)    ( (1ULL<<a) <<MSR_TALENT_HEADER_SHIFT)
#define MSR_TALENT(h,id)        ( MSR_TALENT_HEADER(h) | (1ULL<<id) )
